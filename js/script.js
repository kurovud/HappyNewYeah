...
const WISH_MESSAGES = [
    ...
    "Chúc em có một năm mới đầy ắp tiếng cười và hạnh phúc 🥳",
    "Chúc bé luôn tràn đầy năng lượng tích cực và niềm vui trong cuộc sống 🌟",
    "Chúc bé luôn đạt được những mục tiêu và ước mơ của mình 🎯",
    "Chúc em có một năm mới tràn đầy sức khỏe và thành công 💖",
    "Chúc em luôn được yêu thương và quan tâm từ mọi người xung quanh 💕",
    "Chúc em có một năm mới đầy ắp những khoảnh khắc đáng nhớ và ý nghĩa 📸",
    "Chúc em luôn giữ được sự lạc quan và niềm tin vào cuộc sống 🌈",
    "Chúc bé có một năm mới tràn đầy những trải nghiệm mới và thú vị 🌍",
    "Chúc em luôn được bao quanh bởi những người thân yêu và bạn bè tốt 🤗",
    "Và năm mới bé bớt bơ toy lại kiếm toy nhiều nhiều nha, bơ miết là buồn lắm đó he! 🎊",
];
